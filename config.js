...
const config = {
    // Bot Identity
    botName: process.env.BOT_NAME || "Tharun's AI Assistant",
    botOwner: process.env.BOT_OWNER || 'Tharun Prabhashwara',
    ownerNumber: process.env.OWNER_NUMBER || '94775585251',
    author: process.env.AUTHOR || 'Tharun Prabhashwara',
    packname: process.env.PACKNAME || "Tharun's AI Assistant",
    ...
    updateZipUrl: process.env.UPDATE_URL || 'https://github.com/tharunprabashwara642-dot/MEGA-MD/archive/refs/heads/main.zip',
    ytChannel: process.env.YT_CHANNEL || 'Tharun Prabhashwara',

    // Session
    sessionId: process.env.SESSION_ID || '',
    pairingNumber: process.env.PAIRING_NUMBER || '94775585251',
